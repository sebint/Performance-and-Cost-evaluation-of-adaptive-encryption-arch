...
<html lang="en">
    ...
    <body>
        ...
        <%  int id = Integer.parseInt(session.getAttribute("iCloud_user_id").toString());
            ...
            int DecriptId = 0;
            try {
                String _value = session.getAttribute(request.getParameter("f_id")).toString();
                DecriptId = Integer.parseInt(im.decrypt(request.getParameter("f_id"), _value));
            } catch (NullPointerException npex) {
                response.sendRedirect("javascript:history.back(); return false;");
            }
            ...
            ResultSet rsFolder = dbc.getData("{call icloud_proc_get_folder(?,?)}", id, DecriptId);
            int[] filecount = dbc.file_Count(id);
            int[] othercount = dbc.other_Count(id);
            rsFile = dbc.getFile(DecriptId, id);
            if (request.getParameter("typeId") != null) {
                if (request.getParameter("typeId").equals("1")) {
                    rsFile = dbc.getFile_OnType(id, 1);
                }
                if (request.getParameter("typeId").equals("2")) {
                    rsFile = dbc.getFile_OnType(id, 2);
                }
                if (request.getParameter("typeId").equals("3")) {
                    rsFile = dbc.getFile_OnType(id, 3);
                }
                if (request.getParameter("typeId").equals("4")) {
                    rsFile = dbc.getFile_OnType(id, 4);
                }
                if (request.getParameter("typeId").equals("5")) {
                    rsFile = dbc.getFile_OnType(id, 5);
                }
            }
        %>
        <!-- top navigation -->
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class="mail-toolbar clearfix">
                                        <div class="float-left">
                                            <a href="javascript:;" class="btn btn-default" onclick="window.location='index.jsp'">
                                            ...
                                            <a href="#" class="btn btn-default" onclick="window.location=window.location.href">
                                                <i class="fa fa-refresh"> </i>
                                            </a>
                                            
<!--                                            <a href="javascript:;" title="" class="btn btn-default" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <div class="btn-group m-r-sm mail-hidden-options" style="display: inline-block;">
                                                <div class="btn-group">   
                                                    ...
                                                    <form action="File_enc_on_data?fder_id=<%=DecriptId%>" method="post"  enctype="multipart/form-data">
...
//                                                                        };
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="modal fade bs-example1-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                            <form action="Create_Folder?pfolder_id=<%=DecriptId%>" method="post">
                                                                <div class="modal-content">
                                                ...
                                                <div class="btn-group btn-default" data-toggle="tooltip" data-placement="left" title="Deleted">
                                    ...
                                    <!--                                    <div class="">
                                                                            <i class="fa fa-home"></i><a href="index.jsp">Home</a>&nbsp;<i class="fa fa-arrow-right"></i>
                                                                            <i class="fa fa-folder"></i><a href="index.jsp"><%out.print(request.getParameter("f_name")); %></a>
                                                                        </div>
                                                                        <br>-->
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <table class="table project table-hover" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                rsFolder = dbc.getData("{call icloud_proc_get_folder(?,?)}", id, DecriptId);
                                                                if (rsFolder.next()) {
                                                                    flag = 1;
                                                                    rsFolder = dbc.getData("{call icloud_proc_get_folder(?,?)}", id, DecriptId);
                                                                    while (rsFolder.next()) {
                                                            ...
                                                            <tr id="dataFolder">
                                                                ...
                                                                <td><a href="#" ><i class="fa fa-folder big custom_color_folder"></i></a></td>
                                                                <td>
                                                                    <a href="view_files.jsp?f_name=<%out.print(rsFolder.getString("icloud_folder_name"));%>&f_id=<% out.print(encriptId[0]);
                                                                        session.setAttribute(encriptId[0], encriptId[1]); %>"><% out.print(rsFolder.getString("icloud_folder_name")); %></a>
                                                                    <br />
                                                                ...
                                                                <td>
                                                                    <!--                                                                    <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                                                                                                                                        <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Rename </a>
                                                                                                                                            <input type="hidden" id="btnclicked" name="btnclicked" value="<%=rsFolder.getString("icloud_folder_id")%>">
                                                                                                                            
                                                                                                                                            <button class="btn btn-danger btn-xs" data-toggle="modal" data-target=".bs-delete-modal-sm" name="<%=rsFolder.getString("icloud_folder_name")%>"><i class="fa fa-trash-o"></i> Delete </button>-->
                                                                    <div class="btn-group">
                                                            ...
                                                            <tr id="dataFile">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <!--                                                                    <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-cloud-download"></i> Download </a>
                                                                                                                                        <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Rename </a>
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td class="no_files_found"><img src="../images/noFiles.png"><br>
                                                                    No Files Found Under the Folder <span><% out.print(request.getParameter("f_name")); %></span>.<br>
                                                                    <a class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add Files</a>
                                                                </td>
                                                            </tr>
                                                            <%
                                                                }
        ...
        <script>
            function loadData(gettype) {
                if (gettype == 1) {
                    window.location = '?typeId=1';
                }
                if (gettype == 2) {
                    window.location = '?typeId=2';
                }
                if (gettype == 3) {
                    window.location = '?typeId=3';
                }
                if (gettype == 4) {
                    window.location = '?typeId=4';
                }
                if (gettype == 5) {
                    window.location = '?typeId=5';
                }
//                var xmlhttp;
//                if (window.XMLHttpRequest)
//                {
...
//                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
//                    {
//                        var gettype = xmlhttp.responseText;
//                       
//                    }
//                }
//                xmlhttp.open("POST", "valReturn?typeid=" + typeid);
//                xmlhttp.send();
            }
